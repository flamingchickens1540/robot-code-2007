...
#define R_MIN_DEFAULT	100	// Rmin for call to Track_Color()
#define R_MAX_DEFAULT	110		// Rmax for call to Track_Color()
#define G_MIN_DEFAULT	11		// Gmin for call to Track_Color()
#define G_MAX_DEFAULT	21		// Gmax for call to Track_Color()
#define B_MIN_DEFAULT	121 	// Bmin for call to Track_Color()
#define B_MAX_DEFAULT	131 	// Bmax for call to Track_Color()
